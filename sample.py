...
def main_win():
    ...
    btn7=Button_Canvas(x1=750,y1=420,x2=790,y2=470,text='退出',canvas=canvas,func=quit,tag=[tag,'btn7'])
...
def comment():
    ...
    draw=Draw_Canvas(canvas=canvas,x1=100,y1=100,x2=700,y2=400,tag=[tag,'draw'],path='comment')
    btn3=Button_Canvas(x1=100,y1=400,x2=200,y2=490,text='保存',canvas=canvas,func=draw.Save,tag=[tag,'btn3'])
    btn4=Button_Canvas(x1=200,y1=400,x2=300,y2=490,text='撤销',canvas=canvas,func=draw.Back,tag=[tag,'btn4'])
    btn5=Button_Canvas(x1=300,y1=400,x2=400,y2=490,text='清屏',canvas=canvas,func=draw.Clear,tag=[tag,'btn5'])
...
def sign():
    ...
    draw=Draw_Canvas(canvas=canvas,x1=100,y1=100,x2=700,y2=400,tag=[tag,'draw'],path='sign')
    btn3=Button_Canvas(x1=100,y1=400,x2=200,y2=490,text='保存',canvas=canvas,func=draw.Save,tag=[tag,'btn3'])
    btn4=Button_Canvas(x1=200,y1=400,x2=300,y2=490,text='撤销',canvas=canvas,func=draw.Back,tag=[tag,'btn4'])
    btn5=Button_Canvas(x1=300,y1=400,x2=400,y2=490,text='清屏',canvas=canvas,func=draw.Clear,tag=[tag,'btn5'])
